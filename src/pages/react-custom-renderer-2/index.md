...
Next part of the blog series will cover the update phase of the renderer after setState is invoked. [⚛️🤟 Part 3/3 - Beginners guide to Custom React Renderers. How to build your own renderer from scratch?](/react-custom-renderer-3/)
